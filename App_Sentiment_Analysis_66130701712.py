...
background_image_url = "https://images.pexels.com/photos/1903702/pexels-photo-1903702.jpeg?auto=compress&cs=tinysrgb&w=600"
...
st.markdown(
    ...
    <style>
        ...
        div.stButton > button:hover {
            background-color: #66CCCC;  /* เปลี่ยนสีเมื่อ Hover */
            color: white;
        }
    </style>
    """,
